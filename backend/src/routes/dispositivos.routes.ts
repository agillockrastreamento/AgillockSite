...
router.post('/', requireRoles('ADMIN', 'COLABORADOR'), upload.single('imagem'), async (req: AuthRequest, res: Response): Promise<void> => {
  ...
  const {
    ...
    odometro, enderecoMac, mapa, exibirNoMapaIapro, multasHabilitado, eventosAdminHabilitado,
  ...
  const dispositivo = await prisma.dispositivo.create({
    data: {
      ...
      exibirNoMapaIapro: exibirNoMapaIapro === undefined ? false : (exibirNoMapaIapro === 'true' || exibirNoMapaIapro === true),
      multasHabilitado: multasHabilitado === undefined ? false : (multasHabilitado === 'true' || multasHabilitado === true),
      eventosAdminHabilitado: eventosAdminHabilitado === undefined ? true : (eventosAdminHabilitado === 'true' || eventosAdminHabilitado === true),
...
router.put('/:id', requireRoles('ADMIN', 'COLABORADOR'), upload.single('imagem'), async (req: AuthRequest, res: Response): Promise<void> => {
  ...
  const dispositivo = await prisma.dispositivo.update({
    ...
    data: {
      ...
      ...(multasHabilitado !== undefined ? { multasHabilitado: multasHabilitado === 'true' || multasHabilitado === true } : {}),
      ...(eventosAdminHabilitado !== undefined ? { eventosAdminHabilitado: eventosAdminHabilitado === 'true' || eventosAdminHabilitado === true } : {}),
