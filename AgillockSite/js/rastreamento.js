...
const TIPOS_EVENTO_ADMIN = [
  ...
  { tipo: 'geofenceExit',   label: 'Saída da Zona',     css: 'tipo-geofence' },
      ...
      acoesSection.insertAdjacentHTML('afterend', `
        <div style="border-top:1px solid rgba(128,128,128,.15);margin-top:10px;padding-top:10px">
          ...
          <div style="margin-top:10px">
            <a href="${_urlDetalheRastreamentoAdmin(v.dispositivoId)}" class="btn btn-xs btn-warning" style="flex:1;text-align:center;color:#fff; border-radius:10px;">
