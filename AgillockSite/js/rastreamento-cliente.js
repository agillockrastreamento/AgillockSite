...
function mostrarCardDispositivo(id) {
  ...
  const horasHtml = `
    <div class="dcard-section dcard-val" style="font-size:10px">
      ...
      ${p ? `
        <div style="margin-bottom:2px; margin-left:-4px"><i class="fa fa-mobile" style="${ico}"></i> <span class="dcard-lbl">Dispositivo:</span> <span id="dcard-ts-dev">${fmtGPSTimeSec(p.deviceTime)}</span></div>
      ` : ''}
    </div>`;
